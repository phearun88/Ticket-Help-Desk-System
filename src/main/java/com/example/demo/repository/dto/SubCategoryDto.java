...
public class SubCategoryDto {
	...
	public SubCategoryDto(int sub_cate_id, String sub_category_nm, String sub_category_st, int cate_id, String user_id,
	...
	public String toString() {
		return "SubCategoryDto [sub_cate_id=" + sub_cate_id + ", sub_category_nm=" + sub_category_nm
