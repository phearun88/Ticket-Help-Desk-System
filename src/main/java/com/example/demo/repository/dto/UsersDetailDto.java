...
public class UsersDetailDto {
	...
	public UsersDetailDto(int id, String user_code, String user_nm_kh, String user_nm_en, String user_gender,
	...
	public String toString() {
		return "UsersDetailDto [id=" + id + ", user_code=" + user_code + ", user_nm_kh=" + user_nm_kh + ", user_nm_en="
				+ user_nm_en + ", user_gender=" + user_gender + ", user_dob=" + user_dob + ", user_id_cd=" + user_id_cd
				+ ", user_position=" + user_position + ", dept_nm=" + dept_nm + ", usr_old_add=" + usr_old_add
				+ ", usr_new_add=" + usr_new_add + ", usr_tel=" + usr_tel + ", usr_email=" + usr_email
