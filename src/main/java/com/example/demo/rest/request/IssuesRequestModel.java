...
public class IssuesRequestModel {
	private int iss_id;
	...
	public IssuesRequestModel() {
		// TODO Auto-generated constructor stub
	}

	

	public IssuesRequestModel(int iss_id, String iss_nm, int iss_cate_id, int iss_subcate_id, String iss_desc,
			String iss_status, String iss_priority, String iss_assignee, String user_code, String iss_done,
			String started_date, String due_date, String iss_yn, String created_date, String updated_date) {
		super();
		this.iss_id = iss_id;
		this.iss_nm = iss_nm;
	...
	public String toString() {
		return "IssuesRequestModel [iss_id=" + iss_id + ", iss_nm=" + iss_nm + ", iss_cate_id=" + iss_cate_id
				...
				+ iss_yn + ", created_date=" + created_date + ", updated_date=" + updated_date + "]";
	}
